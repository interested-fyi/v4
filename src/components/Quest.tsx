...
export default function Quest() {
  const [questPoints] = useState(10); // Changeable points variable
  ...
  const handleComplete = (stepId: string) => {
    ...
    setTotalPoints((prevPoints) => prevPoints + questPoints);
  };

  return (
    <div className='min-h-screen bg-gradient-to-br from-blue-700 via-blue-400 to-yellow-200 flex items-center justify-center p-4'>
